...
/**
 * FeedbackThankYouPage — Phase 33
 * Route: /meeting/:meetingId/feedback/thank-you
 *
 * Standalone page shown after successful feedback submission.
 */
export const FeedbackThankYouPage = () => {
