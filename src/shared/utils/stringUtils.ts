 ...
 * Useful for flexible search (fuzzy search).
 */
...
/**
 * Checks if a search term matches a target string, ignoring Vietnamese accents.
 */
export const flexibleSearch = (searchTerm: string, target: string): boolean => {
